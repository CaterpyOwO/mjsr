function crossProduct(triangle) {
    let line1 = [triangle[1][0] - triangle[0][0], triangle[1][1] - triangle[0][1], triangle[1][2] - triangle[0][2]],
        line2 = [triangle[2][0] - triangle[0][0], triangle[2][1] - triangle[0][1], triangle[2][2] - triangle[0][2]];
    let normal = [line1[1] * line2[2] - line1[2] * line2[1], line1[2] * line2[0] - line1[0] * line2[2], line1[0] * line2[1] - line1[1] * line2[0]];
...
function shadeColour(colour, dp) {
    ...
    return ["#", ...colour.map((c) => Renderer.Math.clamp(Math.floor(parseInt(c, 16) * ((dp + 1) * .5)), 25, 255).toString(16))].join("");
}
